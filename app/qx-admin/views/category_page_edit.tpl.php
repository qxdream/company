<?php
/* 
 [QXDream] category_page_edit.tpl.php 2010-02-03
*/
...
<table class="table_no_border m_b_10">
		<tbody>
				...
				<tr>
						...
						<td>
								<select name="category[template]">
										...
										?>
										<option value="<?php echo $k; ?>"<?php if($k == $cat_data['template']) { echo ' selected="selected"'; } ?>><?php echo $v; ?></option>
										<?php
											}
										}
										?>
								</select>
								<input type="hidden" name="category[type]" value="<?php echo $cat_data['type']; ?>" />
				...
				<tr>
						...
						<td>
								<label><input name="category[is_nav]" value="1" type="checkbox"<?php if($cat_data['is_nav'] == 1) echo ' checked="checked"'; ?>>&nbsp;&nbsp;<?php echo $admin_language['set_navigation']; ?></label>
