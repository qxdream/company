...
define('DB_NAME', 'qxdm_mutiuser'); //数据库名称
define('DB_PRE', 'qxdm_'); //数据表前缀
...
//安全设置
define('QX_KEY', 'qxdm-sa3k-k3j9-883a'); //登录验证密钥
...
//其他设置
define('CREATOR', '1'); //创始人ID,多个用逗号隔开
define('RUNTIME', FALSE); //启用RUNTIME功能
